import SDC from 'npm:statsd-client';

const statsServerHost = Deno.env.STATSD_SERVER_HOST || 'localhost';
const statsServerPort = parseInt(Deno.env.STATSD_SERVER_PORT || '8125', 10);
