import prometheusClient from 'npm:prom-client';
import * as logger from '../logger.ts';

const clusterEnabled = Deno.env.CLUSTER_ENABLED !== 'false';
const instanceID = Deno.env.INSTANCE_ID || 'localhost';
...
export class Prometheus {
  ...
  newHistogramStat(name, help, labelNames, buckets?: any) {
    let histogram;
    if (buckets) {
